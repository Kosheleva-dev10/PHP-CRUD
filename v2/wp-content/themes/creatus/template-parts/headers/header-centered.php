...
$wrapper_c		= 'header-centered-wrapper'.$anc;
$header_c		= 'thz-mobile-hidden thz-tablet-hidden header-centered header_holder';
...
<div class="<?php echo thz_sanitize_class( $wrapper_c ) ?>"<?php echo thz_sanitize_data($and); ?>>
    ...
    <?php } ?>
        <div id="mainmenu_holder" class="thz-mobile-hidden thz-tablet-hidden thz-poz-menu-center thzmega<?php thz_contained('tm_contained/picked',true,true) ?><?php echo thz_sanitize_class( $sticky_class) ?>">
            <div class="thz-container thz-menu-holder<?php thz_contained('tm_contained/notcontained/nav_contained',true,true) ?>">
                <?php thz_wp_nav_menu('centered') ?>
            </div>
        </div>
    <?php if($sticky =='active'){ ?>
    </div>
