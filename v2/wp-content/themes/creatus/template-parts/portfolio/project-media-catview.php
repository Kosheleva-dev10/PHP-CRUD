...
$hover_bgtype		= thz_ov_ef('.thz-portfolio','background/type');
$hover_ef 			= thz_ov_ef('.thz-portfolio','oeffect');
$hover_tr 			= thz_ov_ef('.thz-portfolio','oduration');
$img_ef				= thz_ov_ef('.thz-portfolio','ieffect');
$img_tr 			= thz_ov_ef('.thz-portfolio','iduration');
$icons_ef 			= thz_ov_ef('.thz-portfolio','iceffect');
$icons_tr 			= thz_ov_ef('.thz-portfolio','icduration');
...
if( $mediacount > 1 ){
	...
	$slider_layout 	 	 = thz_get_theme_option('project_style/slider',null);
	$slider_animation 	 = thz_get_theme_option('project_style/slider_a',null);
	...
	$start_slick_wrap	 = '<div class="thz-slick-holder'.$multiple.'">';
...
<?php if ( !empty($post_media) ){ 
        ...
        <div class="<?php echo esc_attr( $img_ratio ) ?>">
            <div class="thz-ratio-in">
                ...
                <div class="thz-hover <?php echo esc_attr ( $hover_classes ) ?> thz-items-grid-image"<?php echo $style ?>>
                    ...
                    <?php } ?>
                    <?php if ( $display_mode != 'directional' ) { ?> 
                    <div class="thz-hover-mask <?php echo esc_attr ( $hover_tr ) ?>">
                        <div class="thz-hover-mask-table">
                            ...
                            <div class="thz-hover-icons<?php echo esc_attr( $icons_classes ) ?>">
                                <?php echo thz_print_post_media_icons($project_atts,$item_link,$media); ?>
                            </div>
                        </div>
                    </div>
                    <?php } ?>
    ...
    <?php if($type ==='selfvideo') { echo $start_slick_item; ?>
        <div class="t<?php echo $ratio_class ?>">
            <div class="thz-ratio-in">
                <video id="thz_media<?php echo esc_attr ( $mediaid ) ?>" class="<?php echo $media_class ?> thz-video-html5 thz-media-respond">
