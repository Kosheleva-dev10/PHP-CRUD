			...
			'filter' => array(
				...
				'picker' => array(
					'picked' => array(
						...
						'desc' => esc_html__('Show/hide filter. Note that if all items belong to same category, filter is not shown.', 'creatus'),
						'type' => 'switch',
						'right-choice' => array(
							'value' => 'hide',
							'label' => __('Hide', 'creatus')
				...
				'choices' => array(
					'show' => array(
						'filter_bs' => array(
							...
							'preview' => true,
							'desc' => esc_html__('Adjust .thz-projects-filter box style', 'creatus'),
