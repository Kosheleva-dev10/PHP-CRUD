...
class FW_Shortcode_Sections_Slider extends FW_Shortcode
{
	/**
	 * @internal
	 */
	...
	{
		$data['sections_slider'] = $this->get_item_data();
	...
	private function get_shortcode_config()
	{
		...
		return array_merge(
			array(
				...
				'description' => __('Sections container', 'creatus'),
				'title_template' => null,
			),
	...
	public function _action_register_builder_item_types() {
		if (fw_ext('page-builder')) {
			require $this->get_declared_path(
			    '/includes/page-builder-sections-slider-item/class-page-builder-sections-slider-item.php'
            );
		}
	}
}
