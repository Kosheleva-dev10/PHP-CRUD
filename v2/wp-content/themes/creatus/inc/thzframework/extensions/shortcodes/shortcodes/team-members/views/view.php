...
if('slider' == $layout){
	...
	$grid_holder_classes 	= $css_class.'thz-shc thz-team-members-holder thz-info-'.$info_align.' thz-slick-holder'.$multiple.$mfp_slider.$mode_class.$cpx_class.$res_class;
	...
	$grid_classes 			= 'thz-items-grid thz-team-members-grid'.$no_response.$mfp_slider;
