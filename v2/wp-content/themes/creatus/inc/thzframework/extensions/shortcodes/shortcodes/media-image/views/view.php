...
$style 				= $height == 'auto' ? '' : thz_print_img_style( $image['attachment_id'], $media_size );
$swap_output 		= '';
...
if($swap =='active'){
	...
	$swap_style  	= thz_print_img_style( $swap_image['attachment_id'], $swapimg_size );
...
if ($height =='auto' ) {
	$image_html .= thz_print_img_html($image['attachment_id'], $media_size, array('class' => $img_tr , 'alt' => $img_alt));
}
if ( $over_mode =='none' ) {
