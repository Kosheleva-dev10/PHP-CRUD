...
$mfp_slider			= ' '.thz_akg('lightbox_slider',$atts,'thz-mfp-show-slider');
...
if('slider' == $media_layout){
	...
	$grid_holder_classes 	= $css_class.'thz-shc thz-media-holder thz-slick-holder thz-lightbox-gallery-simple'.$multiple.$mfp_slider.$mode_class.$cpx_class.$res_class;
	...
	$grid_classes 			= 'thz-items-grid thz-media-gallery-grid thz-lightbox-gallery-simple'.$no_response.$mfp_slider;
