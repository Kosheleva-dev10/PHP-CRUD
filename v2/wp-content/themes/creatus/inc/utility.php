...
*/
function _thz_container_metrics_defaults (){
...
*/
function thz_print_cpx($data,$class = false){
...
function thz_dummy_post_ids($number,$key){
	...
	$args = array(
		'numberposts' => $number,
		'post_type' => thz_list_post_types(false,array('forum','topic','reply' )),
		'post_status' => 'publish',
	);
