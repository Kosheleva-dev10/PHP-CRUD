...
function _thz_action_widgets_init() {
   ...
   // right sidebar
	...
	// grid widget areas
	$ah_sections 		= thz_get_theme_option('above_header_section',null);
	$uh_sections 		= thz_get_theme_option('under_header_section',null);
	$footer_sections 	= thz_get_theme_option('footer_section',null);
	$top_panel 			= thz_get_theme_option('top_panel',null);
	$bottom_panel 		= thz_get_theme_option('bottom_panel',null);
	$side_panel 		= thz_get_theme_option('side_panel',null);
