        ...
        <div class="main-content">
            <div class="row">
                ...
                <div class="pull-right">
                    <button type="button" class="btn btn-outline-primary mb-2" onclick="CreateAllAccounts()">Create Accounts(All Files)</button>
                </div>
                </div>
            </div>
            <br>
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="file_list table_responsible"></div>
                </div>
            </div>
        </div>
