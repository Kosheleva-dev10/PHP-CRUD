                ...
                <li class="nav-item align-self-center search-animated">
                    <form class="form-inline search-full form-inline search" role="search">
                        <div class="search-bar">
                            <input type="text" id="search_text" class="form-control search-form-control ml-lg-auto" placeholder="Search...">
                        </div>
                    </form>
                    <svg onclick="searchStaff()" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-search toggle-search"><circle cx="11" cy="11" r="8"></circle><line x1="21" y1="21" x2="16.65" y2="16.65"></line></svg>
                </li>
            </ul>
        ...
        <div class="main-content">
            <div class="row">
                <div class="col-md-12">
                    <div class="pull-right">
                        <button class="btn btn-outline-primary mb-2" data-toggle="modal" data-target="#add_new_record_modal">Add New Staff</button>
                    </div>
                </div>
            </div>
            <br>
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="records_content table_responsible"></div>
                </div>
            </div>
        </div>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-outline-primary mb-2" onclick="addStaff()">Save</button>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="modal fade" id="update_staff_modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-outline-warning mb-2" data-dismiss="modal">Cancel</button>
                    <button type="button" class="btn btn-outline-primary mb-2" onclick="UpdateStaffDetails()" >Save Changes</button>
    ...
    <div class="modal fade" id="update_admin_proifle" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-outline-default mb-2" data-dismiss="modal">Cancel</button>
